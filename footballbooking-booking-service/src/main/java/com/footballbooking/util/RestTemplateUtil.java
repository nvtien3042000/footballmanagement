...
public class RestTemplateUtil {
	...
	public JsonNode getObjectNode(String url, HttpEntity<Map<String, String>> formData) throws JsonMappingException, JsonProcessingException {
		ResponseEntity<String> response = restTemplate.exchange(url, HttpMethod.GET, formData, String.class);
		return mapper.readTree(response.getBody()).path("data");
	}
	
	public JsonNode postObjectNode(String url, HttpEntity<MultiValueMap<String,String>> formData) throws JsonMappingException, JsonProcessingException {
